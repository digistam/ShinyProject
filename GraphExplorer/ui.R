  ...
  mainPanel(
    tabsetPanel(
      tabPanel("Introduction",
               ...
               HTML('The example file <b>"testgraph.csv"</b>, which you can get from GitHub:'),
               p(),
               HTML('<a target=_blank href="https://github.com/digistam/ShinyProject/blob/master/GraphExplorer/testgraph.csv">download here</a>')  
               p(),
               HTML('is comma separated, '),
